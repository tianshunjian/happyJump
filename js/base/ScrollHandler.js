...
var ScrollHandler = function () {
    ...
    // _classCallCheck(this, ScrollHandler);
        ...
        this._direction = options.direction;//滑动方向，x:水平方向，y：垂直方向
...
ScrollHandler.prototype = {
    ...
    onTouchMove:function(dx, dy) {
        ...
        }else if (pos < -this._extent) {
            pos = (pos + this._extent) * UNDERSCROLL_TRACKING - this._extent;
        }
        this._position = pos;
    ...
    onTouchEnd:function(dx, dy, velocity) {
        ...
        if (this._direction=='y'){
            ...
            this._scroll.set(this._position, velocity.x);
        }
        ...
        this._animation = this.animation(this._scroll, function () {
            let now = Date.now();
            let t = (now - that._scroll._startTime) / 1000.0;
            let pos = that._scroll.x(t);
